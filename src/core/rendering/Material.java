 ...
 * Adapted from Steve Maddock's COM3503 Tutorial
 *
...
public class Material {
  ...
  public static final Vec3 DEFAULT_DIFFUSE = new Vec3(0.2f, 0.2f, 0.2f);
  public static final Vec3 DEFAULT_SPECULAR = new Vec3(0.2f, 0.2f, 0.2f);
  public static final Vec3 DEFAULT_EMISSION = new Vec3(0.0f, 0.0f, 0.0f);
  public static final float DEFAULT_SHININESS = 0.7f;
